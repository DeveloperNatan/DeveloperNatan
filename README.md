...
- Autenticação e autorização no backend (JWT)
...
### 🗺️ Snipe PA (demanda real)

<a href="https://mapa-site-novo.onrender.com" target="_blank">Acessar aplicação</a>

Projeto monolítico desenvolvido para atender uma demanda real da empresa: localizar máquinas e seus locais físicos, com histórico de movimentações e análises.
